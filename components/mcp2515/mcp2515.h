...
enum /*class*/ MCP2515_CANINTF : uint8_t {
    CANINTF_RX0IF = 0x01,
    CANINTF_RX1IF = 0x02,
    CANINTF_TX0IF = 0x04,
    CANINTF_TX1IF = 0x08,
...
enum /*class*/ MCP2515_EFLG : uint8_t {
    EFLG_RX1OVR = (1<<7),
    EFLG_RX0OVR = (1<<6),
    EFLG_TXBO   = (1<<5),
    EFLG_TXEP   = (1<<4),
...
enum /*class*/ MCP2515_STAT : uint8_t {
    STAT_RX0IF = (1<<0),
    STAT_RX1IF = (1<<1)
};
...
enum /*class*/ MCP2515_TXBnCTRL : uint8_t {
    TXB_ABTF   = 0x40,
    TXB_MLOA   = 0x20,
    TXB_TXERR  = 0x10,
    TXB_TXREQ  = 0x08,
...
enum /*class*/ MCP2515_INSTRUCTION : uint8_t {
...
enum /*class*/ MCP2515_REGISTER : uint8_t {
    MCP_RXF0SIDH = 0x00,
    MCP_RXF0SIDL = 0x01,
    MCP_RXF0EID8 = 0x02,
    MCP_RXF0EID0 = 0x03,
...
static const struct MCP2515_TXBn_REGS {
    REGISTER CTRL;
    REGISTER SIDH;
    REGISTER DATA;
} MCP2515_TXB[N_TXBUFFERS];

static const struct MCP2515_RXBn_REGS {
    REGISTER CTRL;
    REGISTER SIDH;
    REGISTER DATA;
    CANINTF  CANINTF_RXnIF;
} MCP2515_RXB[N_RXBUFFERS];

MCP2515_ERROR MCP2515_setMode(const CANCTRL_REQOP_MODE mode);
...
MCP2515_ERROR MCP2515_setClkOut(const CAN_CLKOUT divisor);
MCP2515_ERROR MCP2515_setBitrate(const CAN_SPEED canSpeed);
MCP2515_ERROR MCP2515_setBitrate(const CAN_SPEED canSpeed, const CAN_CLOCK canClock);
MCP2515_ERROR MCP2515_setFilterMask(const MASK num, const bool ext, const uint32_t ulData);
MCP2515_ERROR MCP2515_setFilter(const RXF num, const bool ext, const uint32_t ulData);
MCP2515_ERROR MCP2515_sendMessage(const TXBn txbn, const struct can_frame *frame);
MCP2515_ERROR MCP2515_sendMessage(const struct can_frame *frame);
MCP2515_ERROR MCP2515_readMessage(const RXBn rxbn, struct can_frame *frame);
