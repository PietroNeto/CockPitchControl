...
static const char *TAG_SPI = "SPI CAN";

const struct MCP2515_TXBn_REGS MCP2515_TXB[MCP2515_N_TXBUFFERS] = {
    {MCP_TXB0CTRL, MCP_TXB0SIDH, MCP_TXB0DATA},
    {MCP_TXB1CTRL, MCP_TXB1SIDH, MCP_TXB1DATA},
    {MCP_TXB2CTRL, MCP_TXB2SIDH, MCP_TXB2DATA}
};

const struct MCP2515_RXBn_REGS MCP2515_RXB[N_RXBUFFERS] = {
...
MCP2515_ERROR MCP2515_reset(void)
{
    ...
    if (ret != ESP_OK) {
        printf("spi_can_transaction failed\n");
    }
...
MCP2515_ERROR MCP2515_setBitrate(const CAN_SPEED canSpeed, CAN_CLOCK canClock)
{
...
MCP2515_ERROR MCP2515_setFilterMask(const MASK mask, const bool ext, const uint32_t ulData)
{
